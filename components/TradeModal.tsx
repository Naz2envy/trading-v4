...
const makeEmpty = (): TradeDraft => ({
  instrument: "NAS100", account: "Personal", direction: "long", result: "win",
...
export function TradeModal({ open, trade, onClose, onSave, onUpload }: {
  open: boolean;
  trade?: Trade | null;
  onClose: ()=>void;
    ...
    <section className="trade-sheet">
      ...
      <form onSubmit={submit}>
        ...
        <div className="form-section"><h3>Trade</h3><div className="trade-form-grid">
          ...
          <label>Account<input value={form.account} onChange={e=>set("account",e.target.value)} placeholder="Vantage Live"/></label>
